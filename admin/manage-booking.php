    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="active"><a href="manage-booking.php"><i class="fas fa-gears"></i> <span>Manage Events</span></a></li>
                <li><a href="contact.php"><i class="fas fa-mobile"></i> <span>Contact</span></a></li>
