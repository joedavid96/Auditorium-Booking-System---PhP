...
<div class="denied__wrapper">
    <h1>ERROR</h1>
    <h3>LOST IN <span>SPACE</span> Nalli Booking? Hmm, looks like something went wrong.</h3>
    ...
    <a href="javascript:window.close()"><button class="denied__link">Go Back</button></a>
</div>
<script>
