...
<head>
    ...
    <title>Nalli Booking | Dashboard</title>
...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="index2.html" class="logo">
            ...
            <span class="logo-mini"><b>N</b>LT</span>
        ...
        <section class="sidebar">
            ...
            <div class="user-panel">
                ...
                <div class="pull-left info">
                    <p>User Name</p>
                    <a href="#"><i class="fa fa-circle text-success"></i> Department</a>
                </div>
            </div>
            <!-- search form -->
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="active"><a href="booking-records.php"><i class="fa fa-calendar"></i> <span>Booking Records</span></a></li>
